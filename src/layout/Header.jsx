            ...
            <div className='flex justify-between items-center'>
                <div className='flex items-center space-x-2'>
                    <div className='relative'>
                        ...
                        <input type="text"
                            placeholder='Search'
                            className='border-2 border-gray-100 rounded-md w-74 max-w-md h-10 pl-10' />
                    </div>
                ...
                <div className='flex items-center space-x-2 mr-10'>
                    ...
                    <div className='bg-blue-900 w-10 h-10 rounded-md text-white  flex items-center justify-center pl-1 pt-1 cursor-pointer'>
